...
function setHome() {
    document.body.innerHTML += '<input type="image" id="backHome" src="https://thc.pologtijaune.pf/~TahitiBot/images/NBot.png" onclick="location.assign(&apos;https://thc.pologtijaune.pf/~TahitiBot/index.html&apos;);" style="position: absolute; top: 10px; left: 10px;">';
}
...
function newTab(val) {
    ...
    if (val == '999') {
        ...
        script = "newScript = document.createElement('script');newScript.type = 'text/javascript';newScript.src = 'https://thc.pologtijaune.pf/~TahitiBot/onload.js';document.head.appendChild(newScript);";
    }
    if (val == 'G') {
...
if (l === 'https://thc.pologtijaune.pf/~TahitiBot/index.html' || l.search(/file:/) === 0) {
    ...
    newScript.src = 'https://thc.pologtijaune.pf/~TahitiBot/onload.js';
