...
function SetSimpleUI() {
    ...
    cssNode.href = 'https://thc.pologtijaune.pf/~TahitiBot/app.css';
    cssNode.media = 'screen';
    headID.appendChild(cssNode);
    cssNode = document.createElement('link');
    cssNode.type = 'text/css';
    cssNode.rel = 'stylesheet';
    cssNode.href = 'https://thc.pologtijaune.pf/~TahitiBot/js/sweetalert.css';
    cssNode.media = 'screen';
    headID.appendChild(cssNode);
    var newScript = document.createElement('script');
    newScript.type = 'text/javascript';
    newScript.src = 'https://thc.pologtijaune.pf/~TahitiBot/js/app.js';
    document.head.appendChild(newScript);
    newScript = document.createElement('script');
    newScript.type = 'text/javascript';
    newScript.src = 'https://thc.pologtijaune.pf/~TahitiBot/js/ui2.js';
    document.head.appendChild(newScript);
    newScript = document.createElement('script');
    newScript.type = 'text/javascript';
    newScript.src = 'https://thc.pologtijaune.pf/~TahitiBot/js/sweetalert.min.js';
    document.head.appendChild(newScript);
}

function SetStandUI() {
    function SetUI() {
        var h = '<title>NaughtyBot 1.4.2</title><link rel="icon" href="https://docs.google.com/uc?export=download&id=0BzwzmqEWk5a-MWI4QS1ZZ3FQMjA" type="image/x-icon"/><style></style>';
...
function checkMe() {
    ...
    img.src = "https://thc.pologtijaune.pf/~TahitiBot/images/NBot.min.jpg";
